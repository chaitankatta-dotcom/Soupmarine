...
Through the website, users can control the submarine’s propulsion, steering, and buoyancy while also viewing real-time system information.

## Features
3D-printable hull and components
Seeed Studio XIAO ESP32-S3 Sense
Custom control website built with JavaScript and HTML
Local server hosted on a laptop
Control from a computer or smartphone
DC motor propulsion
Servo-controlled rear fins
DC motor-powered buoyancy control
Live battery percentage monitoring
Real-time latency display
Live system status and telemetry
How It Works
The submarine is controlled by a Seeed Studio XIAO ESP32-S3 Sense, while a laptop hosts a local web server that serves the control interface. Any device connected to the same network, including a smartphone, can access the website and operate the submarine.

The web interface allows users to:

Control the propulsion motor (forward and reverse)
Adjust the rear fins for steering and pitch
